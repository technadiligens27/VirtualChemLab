...
const CopperSulfate = () =>{
  ...
  const lessonDetailsData = [
  {
    ...
    lessonTitle: "Copper Sulfate Precipitation",

    description:
      "In this lesson, copper sulfate solution is mixed with sodium hydroxide solution. The reaction produces an insoluble light blue copper hydroxide precipitate inside the beaker.",
